...
const stepBackgrounds: Record<string, string> = {
  'Tell Us About Your Pet': '/Birthday/chose%20service_card.png',
  'Pick a Time That Works': '/Birthday/book%20instantly_card.png',
  'We Handle the Rest': '/Birthday/relax%20%26%20enjoy%20_card.png',
};
  ...
  return (
    <section id="how-it-works" className={`${theme.layout.sectionSpacing} scroll-mt-24 bg-[#f8f5f2]`}>
      <div className={theme.layout.container}>
        <FadeInSection>
          <h2 className="text-center text-3xl font-semibold tracking-tight text-ink md:text-4xl">Three Steps to a Happy, Well-Groomed Pet</h2>
        </FadeInSection>
